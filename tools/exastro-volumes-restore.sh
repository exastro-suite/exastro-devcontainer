...
sudo rm -rf "${REPO_ROOT_DIR}/.volumes/ita-mariadb/data/*"
sudo rm -rf "${REPO_ROOT_DIR}/.volumes/ita-mongodb/data/*"
sudo rm -rf "${REPO_ROOT_DIR}/.volumes/platform-db/data/*"
sudo rm -rf "${REPO_ROOT_DIR}/.volumes/platform-db-mysql/data/*"
sudo rm -rf "${REPO_ROOT_DIR}/.volumes/storage/*"
